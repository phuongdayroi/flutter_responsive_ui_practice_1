...
static const Color redDark = Color(0xffd90429);
static const Color blueLight = Color(0xff0077b6);
static const Color blueDark = Color(0xff023e8a);
static const Color greenLight = Color(0xff57cc99);
static const Color greenDark = Color(0xff38a3a5);
}